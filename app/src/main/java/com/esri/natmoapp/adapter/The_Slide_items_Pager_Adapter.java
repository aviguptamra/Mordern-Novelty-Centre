...
public class The_Slide_items_Pager_Adapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        TextView caption_title1 = sliderLayout.findViewById(R.id.my_caption_title1);
        ...
        caption_title1.setText(theSlideItemsModelClassList.get(position).getThe_caption_Title1());
